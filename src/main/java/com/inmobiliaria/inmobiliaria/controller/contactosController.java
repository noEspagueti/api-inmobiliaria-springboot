...
public class contactosController {
	...
	@GetMapping("/{dniContacto}")
	public List<contactosEntity> getAllContactosByDniContacto(@PathVariable("dniContacto") String dniContacto) {
		return servicio.getAllByDniContacto(dniContacto);
	}
}
